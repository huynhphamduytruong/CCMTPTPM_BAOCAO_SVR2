...
<style type="text/css">
	...
	?> 
         ...
         <form action="<?php echo BASE_URL ?>/khachhang/insert_dangky" method="POST">
            ...
            <h5 class="title_login">Đăng Ký Thành Viên</h5>
                        ...
                        <div class="content-box_contact">
                           ...
                           <div class="row">
                              <div class="input">
                                 ...
                                 <input type="text" name="txtDienThoai"  class="clsip">
                              </div>
                              <div class="clear"></div>
                           </div>
                           <!---row---->
            ...
            <form autocomplete="off" action="<?php echo BASE_URL ?>/khachhang/kh_login" method="POST">
            <div class="contact_right">
            <h5 class="title_login">Đăng Nhập</h5>
               <div class="form_contact_in">
                  <div class="box_contact">
                     <form name="FormDatHang" method="post" action="gio-hang/">
                        <div class="content-box_contact">
